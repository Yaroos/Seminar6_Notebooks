...
//    поля
    ...
    public Laptops(String model, Integer guarantee, String OS, String color, Double diagonal, String screenResolution, String CPU, String amountOfRAM, String hardDiskCapacity) {
        this.model = model;
